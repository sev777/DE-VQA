...
from ..models.ike import IKEHyperParams, apply_ike_to_model, apply_ike_to_multimodal_model, apply_ike_to_per_model, apply_hice_to_multimodal_model
...
ALG_MULTIMODAL_DICT = {
    ...
    'HICE': apply_hice_to_multimodal_model,
}
DS_DICT = {
