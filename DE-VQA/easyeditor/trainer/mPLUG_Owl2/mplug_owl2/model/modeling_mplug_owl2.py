...
# Store original configurations and methods
original_llama_config = transformers.models.llama.configuration_llama.LlamaConfig
original_llama_attention = transformers.models.llama.modeling_llama.LlamaAttention
original_llama_decoder_layer = transformers.models.llama.modeling_llama.LlamaDecoderLayer
original_llama_model_forward = transformers.models.llama.modeling_llama.LlamaModel.forward
original_llama_for_causal_lm_forward = transformers.models.llama.modeling_llama.LlamaForCausalLM.forward

def revert_llama_modality_adaptive():
    transformers.models.llama.configuration_llama.LlamaConfig = original_llama_config
    transformers.models.llama.modeling_llama.LlamaAttention = original_llama_attention
    transformers.models.llama.modeling_llama.LlamaDecoderLayer = original_llama_decoder_layer
    transformers.models.llama.modeling_llama.LlamaModel.forward = original_llama_model_forward
    transformers.models.llama.modeling_llama.LlamaForCausalLM.forward = original_llama_for_causal_lm_forward
