...
class BLIP2Output(ModelOutput):
    ...
    opt_tokens: torch.IntTensor = None
    layers_outs: list = None
...
class Blip2OPT(Blip2Base):
    ...
    def forward(self, samples,out_middle=False,**kwargs):
        ...
        loss = outputs.loss
        #attention, before_fc1,after_fc1,after_act,after_fc2,after_dop,after_res
        # attention_28,attention_29,attention_30,attention_31=outputs.attentions[28:]
        # l28=outputs.hidden_states[33:39]
        # l29=outputs.hidden_states[39:45]
        # l30=outputs.hidden_states[45:51]
        # l31=outputs.hidden_states[51:57]
        layers_outs=[]
        if  out_middle:
            # layers_outs=[[28+iid,i,outputs.hidden_states[33+6*iid:39+6*iid]]   for iid,i in enumerate(outputs.attentions[28:] )]
        ...
        return BLIP2Output(
            ...
            layers_outs=outputs.attentions
        )
