...
class ModelVisonArguments:
    vision_tower: Optional[str] = field(default='./multmodal/VLKEB-main/clip-vit-large-patch14-336')
    mm_vision_select_layer: Optional[int] = field(default=-2)
    pretrain_mm_mlp_adapter: Optional[str] = field(default='./LMS/llava-v1.5-7b/mm_projector.bin')
